...
export const BellSlashIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 18.657A8 8 0 016.343 7.343m11.314 11.314A8 8 0 006.343 7.343m11.314 11.314L6.343 7.343m1.414-1.414A6 6 0 0118 11v3.159c0 .538-.214 1.055-.595 1.436L16 17m-4 4v1a3 3 0 01-6 0v-1m6 0H8" />
    </svg>
);
